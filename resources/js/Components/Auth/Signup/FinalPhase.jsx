...
// Use the avatar options from your code
const avatarOptions = [
  'default-1.svg',
  'default-2.svg',
  'default-3.svg',
...
// Generate random avatar from the options
const getRandomAvatar = () => {
  const randomIndex = Math.floor(Math.random() * avatarOptions.length);
  return `/avatar/${avatarOptions[randomIndex]}`;
};

// Mock users with actual avatars
const mockUsers = [
  { id: 1, name: 'Alex Johnson', rank: 1, score: 9850, avatar: getRandomAvatar(), change: 'up', level: 42, streak: 28, highestScore: 12000 },
  { id: 2, name: 'Maya Rodriguez', rank: 2, score: 9720, avatar: getRandomAvatar(), change: 'same', level: 40, streak: 35, highestScore: 10500 },
  { id: 3, name: 'James Chen', rank: 3, score: 9510, avatar: getRandomAvatar(), change: 'up', level: 39, streak: 14, highestScore: 11200 },
  { id: 4, name: 'Sarah Kim', rank: 4, score: 9350, avatar: getRandomAvatar(), change: 'down', level: 38, streak: 7, highestScore: 9800 },
  { id: 5, name: 'Tyrone Williams', rank: 5, score: 9210, avatar: getRandomAvatar(), change: 'up', level: 37, streak: 21, highestScore: 9500 },
];
